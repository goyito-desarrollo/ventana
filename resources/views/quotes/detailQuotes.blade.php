...
<div class="col-md-12">
 <button type="button"
 id="registrar" class="btn btn-success pull-right" style="margin-left: 5px;">Registrar Cotización</button>
<button type="button"
 id="conpedido" class="btn btn-default pull-right">Con v Pedido</button>
</div>
              </div>
            </div>
          </div>
